...
\usepackage[root,shortcuts]{hedmaths}
...
\renewcommand{\maketitle}{
  ...
  \noindent Студент \( \underset{\small\text{(фамилия, имя, отчество)}}
    {\ul{\text{Слоква Виктория Игоревна}}} \) \\
  ...
  \begin{enumerate}
    ...
    \item Содержание расчетно-пояснительной записки: Работа состоит из
      методического пособия из 6 частей:
      \begin{enumerate}
        \itemsep -4pt
        \item основные сведения;
        \item электроника триода;
        \item режим токоперехвата;
        \item режим возврата электронов;
