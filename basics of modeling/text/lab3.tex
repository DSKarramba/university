  ...
  библиотек matplotlib, numpy и scipy. Он приведён в разделе~\sect{code}.
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{screening}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{radial_density}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{form-factor}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{diffsect}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{sect}
