<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="clients.aspx.cs" Inherits="_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Страница Clients</title>
...
<body>
    <form id="frm4" class="main" runat="server">
      ...
      <div>
        <table class="data" id='TableClients' runat="server">
          <tr>
            <th>i_id_client</th>
            <th>vc_name</th>
            <th>i_id_type</th>
      ...
      <div>
        <asp:SqlDataSource ID="dsC" runat="server" 
          ConnectionString="<%$ ConnectionStrings:labsConnectionString %>" 
          SelectCommand="SELECT tbClients.* FROM tbClients" 
