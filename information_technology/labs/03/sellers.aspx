<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="sellers.aspx.cs" Inherits="_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Страница Sellers</title>
  <link href="style.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="frm3" class="main" runat="server">
      <div id="nav">
        ...
        <asp:Button ID="btP3" runat="server" class="button_sel"
      ...
      <div>
        <table class="data" id='TableSellers' runat="server">
          <tr>
            <th>i_id_seller</th>
            <th>vc_name</th>
          </tr>
      ...
      <div>
        <asp:SqlDataSource ID="dsS" runat="server" 
          ConnectionString="<%$ ConnectionStrings:labsConnectionString %>" 
          SelectCommand="SELECT tbSellers.* FROM tbSellers" 
