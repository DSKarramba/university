<%@ Page Language="C#" AutoEventWireup="true" CodeFile="code_3.cs" Inherits="Default2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Page 3: cities | Lab 2</title>
    ...
    <form id="frm3" class="main" runat="server">
      ...
      <table style="border: 0px; vertical-align: middle; margin: auto;">
        ...
        <tr>
          <th>Город:</th>
          <td>
            <asp:TextBox ID="tbC" runat="server" style="margin-left: 15px"
              Width="200px"></asp:TextBox> <br />
          </td>
        </tr>
      </table>
