<%@ Page Language="C#" AutoEventWireup="true" CodeFile="code_1.cs" Inherits="Default2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Page 1: chat | Lab 2</title>
    ...
    <form id="frm1" class="main" runat="server">
      ...
      <table style="border: 0px; vertical-align: middle; margin: auto;">
        ...
        <tr>
          <th>Сообщение:</th>
          <td>
            <asp:TextBox ID="tbM" runat="server" style="margin-left: 15px"
              Width="200px"></asp:TextBox> <br />
          </td>
        </tr>
      </table>
