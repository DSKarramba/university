    ...
    \begin{center}
        \begin{tabular}{|C{.13}|L{.6}|L{.2}|L{.1}|}
            ...
            \multicolumn{1}{|C{.13}|}{\multirow{3}{*}{3-8}} & Разработана методика тестирования системы 
                кластеризации предпочтений жителей. & \\ \cline{2-3}
            & Произведены испытания разработанной системы кластеризации предпочтений на тестовом наборе входных данных. & \\ \cline{2-3}
